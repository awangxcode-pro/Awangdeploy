...
window.toggleDropdown = () => {
    const drop = document.getElementById('cpDropdown');
...
if(typeof config !== 'undefined') {
    const nameEl = document.getElementById('contactWebName');
    if(nameEl && config.name) nameEl.innerText = config.name;
}
